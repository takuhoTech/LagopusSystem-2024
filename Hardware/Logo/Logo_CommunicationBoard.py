...
offset = 150
img = Image.new("1", (560-offset, 50))

#img.paste(img_main, (0, 0))
#paste(img, 370-offset, 0, 80, [kicad])
...
draw.text((156-offset, 0), detail, fill="white", font=font2)
#draw.text((350-offset, 0), detail2, fill="white", font=font2)

#img.show()
img.save(dir + "Logo_takuhoTech.jpg")
